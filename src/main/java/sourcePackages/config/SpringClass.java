...
@EnableJpaRepositories(basePackages = "sourcePackages") //doi ten package
...
//        dataSource.setUrl("jdbc:mysql://127.0.0.1:3307/jpademo?characterEncoding=UTF-8");
        ...
        dataSource.setUrl("jdbc:mysql://127.0.0.1:3306/transaction_management?characterEncoding=UTF-8&createDatabaseIfNotExist=true");
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactoryBean.setPackagesToScan("sourcePackages"); //doi ten package
